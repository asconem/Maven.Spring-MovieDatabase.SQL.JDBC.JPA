...
# INSERT INTO movies (
#     title, runtime, genre, imdb_score, rating)
# VALUES ('Office Space', 89, 'Comedy', 7.9, 'R');
...
SELECT title, AVG (imdb_score)
FROM movies
GROUP by genre, movies.title;
...
SELECT AVG (imdb_score) FROM movies WHERE rating = 'R' HAVING COUNT(*) > 1;
